...
Documents need to be **preprocessed** by converting in lowercase words, revoming punctuation, spaces, stop words, applying stemming and creating the so called "bag of words".
...
**Proportions of documents for each class** 
...
$$
where $P(S=s | D=j)$ is the probability of $s$ occuring within a document of category $j$.
