...
- There is no significant relation between the number of words in the text and the final rating
...
results=readRDS("~/0dssc/smds/statMethodsProject/computed_results/results_extra_corte_1_15_cd.rds")
...
results=readRDS("~/0dssc/smds/statMethodsProject/computed_results/results_corte_16_50_cd.rds")
    ################plotting mod no bootstrap
...
results=readRDS("~/0dssc/smds/statMethodsProject/computed_results/results_lunghe_51_200_cd.rds")
    ################plotting mod no bootstrap
...
- That's a great news since it means that this package can be used to analyse Tweets, where a major challenge is posed by the fact that 
 users are limited to 240 characters.
...
An overview of the Italian institutional crisis of the 27th of May
...
```{r distro parole}
#plot dei risultati
megatrain=readRDS("~/0dssc/smds/statMethodsProject/computed_results/distro_parole_tweets.rds")
...
mattarella1=readRDS("~/0dssc/smds/statMethodsProject/computed_results/tweet_sentiment_test.rds")
...
```{r Mattarella}
mattarella1=readRDS("~/0dssc/smds/statMethodsProject/computed_results/tweet_mattarella_sentiment.rds")
valori_tot=mattarella1
valori_tot1=valori_tot
valori_tot1$type[valori_tot1$type==0] <- "Contra"
valori_tot1$type[valori_tot1$type==1] <- "Pro"
